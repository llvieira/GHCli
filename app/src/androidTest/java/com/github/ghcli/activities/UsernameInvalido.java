        ...
        ViewInteraction appCompatAutoCompleteTextView3 = onView(
                allOf(withId(R.id.email),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView3.perform(replaceText("lol"), closeSoftKeyboard());
        ...
        ViewInteraction passwordView = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        passwordView.perform(replaceText("haha"), closeSoftKeyboard());

        ViewInteraction passwordView2 = onView(
                allOf(withId(R.id.password), withText("haha"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
