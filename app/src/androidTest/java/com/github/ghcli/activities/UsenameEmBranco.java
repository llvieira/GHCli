...
public class UsenameEmBranco {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void usenameEmBranco() {
        ...
        ViewInteraction passwordView = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        passwordView.perform(replaceText("bbbbb"), closeSoftKeyboard());

        ViewInteraction passwordView2 = onView(
                allOf(withId(R.id.password), withText("bbbbb"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
